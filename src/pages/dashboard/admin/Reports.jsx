            ...
            <div className="overflow-x-auto border border-[var(--border)] rounded-lg">
                ...
                <tbody>
                    ...
                    filteredReports.map((report) => (
                        ...
                        <td className="p-3">{new Date(report.messages[report.messages.length - 1 ].date).toLocaleString()}</td>
                        <td className="p-3">{report.messages.length}</td>
                        <td className="p-3 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                            {/* Go to Job */}
                            <button
                                onClick={() => navigate(`/jobs/${report.id}`)}
                                className="
                                    p-2 rounded-lg 
                                    hover:bg-blue-100 
                                    text-blue-600
