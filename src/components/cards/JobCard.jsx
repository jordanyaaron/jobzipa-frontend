        ...
        <div className="border mb-5 border-[var(--border)] rounded-xl p-4 bg-white dark:bg-gray-900 hover:shadow-md transition">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <Link to={`/jobs/${job.public_id}`}>
                  <h2 className="font-semibold text-[var(--text)] text-lg hover:underline">
                    {job.title}
                  </h2>
                </Link>
          ...
          <Link to={`/jobs/${job.public_id}`}>
            <div
              ...
              dangerouslySetInnerHTML={{ __html: job.description_summary }}
            />
          </Link>
          ...
          <div className="flex justify-between items-center mt-4 pt-3 border-t border-[var(--border)]">
            ...
            <Link
              ...
              className="text-sm px-3 py-2 rounded-md bg-black text-white hover:opacity-80"
            >
              View more
            </Link>
          </div>
